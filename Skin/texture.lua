...
do -- Shapes
    ...
    Base.RegisterTexture("shapeStar", function(frame, texture)
        ...
        if shapes[texture] then
            ...
            _G.hooksecurefunc(texture, "SetVertexColor", function(dialog, ...)
                texture2:SetVertexColor(...)
            end)
            _G.hooksecurefunc(texture, "SetColorTexture", function(dialog, ...)
                texture2:SetColorTexture(...)
            end)
            _G.hooksecurefunc(texture, "SetDesaturated", function(dialog, ...)
                texture2:SetDesaturated(...)
            end)
            _G.hooksecurefunc(texture, "SetAlpha", function(dialog, ...)
                texture2:SetAlpha(...)
            end)
            _G.hooksecurefunc(texture, "SetBlendMode", function(dialog, ...)
